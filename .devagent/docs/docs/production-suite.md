...
**Note:** Local dashboard proposal review writes are shipped. The remaining production gap in this area is broader accepted-evidence consumption beyond the current review ledger and publishing paths.
