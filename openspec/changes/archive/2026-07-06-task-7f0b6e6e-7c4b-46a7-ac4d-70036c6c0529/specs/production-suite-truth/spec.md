...
Define the accuracy requirements for `production-suite.md` so that current-state gaps, milestone shipping status, and remaining-gap links reflect shipped command surfaces. All requirements are traceable to refinement evidence from the docs-truth alignment task (7f0b6e6e-7c4b-46a7-ac4d-70036c6c0529).
