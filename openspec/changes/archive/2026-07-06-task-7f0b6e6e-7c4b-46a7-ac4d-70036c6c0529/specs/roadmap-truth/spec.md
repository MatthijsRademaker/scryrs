...
Define the accuracy requirements for `roadmap.mdx` so that narrative phase descriptions, delivery milestones, and production-ready suite path table distinguish shipped command surfaces from product-complete phase status. All requirements are traceable to refinement evidence from the docs-truth alignment task (7f0b6e6e-7c4b-46a7-ac4d-70036c6c0529).
