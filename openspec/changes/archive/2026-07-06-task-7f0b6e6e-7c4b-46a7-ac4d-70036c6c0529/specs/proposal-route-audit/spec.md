...
Audit confirmation that `proposals.md` and `route-manifests.md` already match shipped behavior. These pages are NOT expected to need edits. Changes SHALL only be made if specific wording drifts from source-code truth discovered during audit. All requirements are traceable to refinement evidence from the docs-truth alignment task (7f0b6e6e-7c4b-46a7-ac4d-70036c6c0529).
