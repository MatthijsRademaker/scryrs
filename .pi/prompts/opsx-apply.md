...
1. **Select the change**
   ...
   Extract the change name from the first word of `$ARGUMENTS`. If a name is provided, use it. Otherwise:
   ...
   **Extra context**: Any text in `$ARGUMENTS` after the change name is additional context or instructions. Keep it in mind throughout implementation.
