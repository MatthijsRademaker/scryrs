...
The `OPENAI_API_BASE` in `~/.cocoindex_code/global_settings.yml` depends on execution context:

- **Local (host):** `http://127.0.0.1:8081/v1`
- **Docker container:** `http://host.docker.internal:8081/v1`

See the SKILL.md "Runtime Context" section for details.
